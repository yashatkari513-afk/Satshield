        ...
        >
          <div className="relative w-8 h-8 flex items-center justify-center">
            ...
            <div
              ...
              style={{ border: '1.5px solid #00eaff', boxShadow: '0 0 10px rgba(0, 234, 255, 0.6)' }}
            />
            {/* Inner dashed ring */}
            <div
              className="absolute inset-[4px] rounded-full"
              style={{ border: '1px dashed rgba(0, 234, 255, 0.45)' }}
            />
            {/* Core planet dot */}
            <div
              className="w-1.5 h-1.5 rounded-full bg-[#00eaff]"
