      ...
      <div className="flex items-center justify-between pb-2 border-b border-white/[0.08]">
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className="inline-flex items-center gap-1 px-2 py-1 rounded bg-[#00BFFF]/10 border border-[#00BFFF]/40 text-[#38BDF8] hover:bg-[#00BFFF]/20 font-sans text-[10px] font-bold tracking-wider uppercase transition-all cursor-pointer"
