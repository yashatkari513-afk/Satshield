...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* ── CENTER: WHITE SEARCH FIELD WITH ⌘K ── */}
      <div className="flex-1 max-w-sm md:max-w-md mx-1 md:mx-3">
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        <button
          ...
          className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-400/40 text-[#38BDF8] text-[11px] font-bold tracking-wider uppercase transition-all cursor-pointer shadow-[0_0_8px_rgba(0,191,255,0.2)]"
          title="Empirical AI Model Validation & Performance Metrics"
        >
          <Brain className="w-3.5 h-3.5 text-[#00BFFF]" />
