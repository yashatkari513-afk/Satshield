...
export function runModelValidation(options?: ValidationRunnerOptions): ValidationReport {
  ...
  // Synchronize the default anomaly detection service decision threshold
  ...
  for (const sample of dataset) {
    ...
    // Standardized empirical decision: sample is predicted as anomaly IF anomalyScore >= active threshold
    const predictedIsAnomaly = detectionOutput.anomalyScore >= threshold;
