    ...
    >
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        <button
          ...
          className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-600 hover:from-sky-400 hover:to-indigo-500 text-white text-[11px] font-black tracking-wider uppercase transition-all cursor-pointer shadow-[0_0_12px_rgba(14,165,233,0.5)] hover:shadow-[0_0_16px_rgba(14,165,233,0.8)] hover:scale-105 active:scale-95 border border-sky-300/50"
