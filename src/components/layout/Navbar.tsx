      ...
      <header className="h-16 w-full bg-[#070b16]/95 backdrop-blur-md border-b border-cyan-500/20 px-3 sm:px-4 flex items-center justify-between z-30 sticky top-0">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <div onClick={() => navigate('/')} className="flex items-center gap-2.5 sm:gap-3 cursor-pointer group">
            <div className="relative flex items-center justify-center p-1 sm:p-1.5 rounded-xl bg-[#020305] border border-cyan-400/40 shadow-[0_0_10px_rgba(0,234,255,0.3)] group-hover:border-cyan-400 transition-colors">
              <OrbitalLogoIcon size={24} />
              <span className="absolute -top-0.5 -right-0.5 w-2 h-2 rounded-full bg-emerald-400 animate-pulse shadow-[0_0_6px_#10B981]" />
            </div>
            <div>
