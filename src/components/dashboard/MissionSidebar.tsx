...
const BASE_SIDEBAR_ITEMS = [
  ...
  { id: 'alerts', label: 'Alerts', icon: AlertTriangle, color: '#EF4444' }, // Red alert (dynamic badge)
    ...
    >
      ...
      <nav className="flex-1 py-3 px-2 space-y-1 overflow-y-auto custom-scrollbar">
        {BASE_SIDEBAR_ITEMS.map((item) => {
          ...
          const badgeValue = item.id === 'alerts' ? activeAlertsCount : (item as any).badge;
