...
# ----------------- Before vs After Report Schemas (Step 28) -----------------
class BeforeReportCaptureRequest(BaseModel):
    satellite_id: str
    telemetry: Dict[str, Any]
...
class AfterReportCaptureRequest(BaseModel):
    satellite_id: str
    telemetry: Dict[str, Any]
    health_score: Optional[float] = 38.0
    risk_level: Optional[str] = "HIGH"
    anomaly_status: Optional[str] = "ANOMALY"
...
class BeforeAfterReportResponse(BaseModel):
    satellite_id: str
    satellite_name: str
    has_before: bool
    has_after: bool
    before_report: Optional[Dict[str, Any]] = None
    after_report: Optional[Dict[str, Any]] = None
