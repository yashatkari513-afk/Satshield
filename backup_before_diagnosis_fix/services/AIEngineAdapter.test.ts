...
export async function runAIEngineTests(): Promise<boolean> {
  ...
  const stableHistory: TelemetryDataPoint[] = [
    { voltage: 28.5, temperature: 24.0, power: 88, signalStrength: 95, current: 6.5 },
    { voltage: 28.5, temperature: 24.1, power: 88, signalStrength: 95, current: 6.4 },
    { voltage: 28.6, temperature: 24.0, power: 88, signalStrength: 95, current: 6.5 },
    { voltage: 28.5, temperature: 24.0, power: 88, signalStrength: 95, current: 6.5 },
  ];
  const stablePoint: TelemetryDataPoint = { voltage: 28.5, temperature: 24.0, power: 88, signalStrength: 95, current: 6.5 };
  ...
  assert(resA.dataQuality.dataQualityRating === 'HIGH', 'Data quality rating is HIGH');
